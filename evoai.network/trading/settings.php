     ...
     if(date.valueOf() > new Date().valueOf())
      ...
      $( document ).ready(function() {
        ...
        var settings = {
              "async": false,
              "crossDomain": true,
              "url": "http://ded4533.inmotionhosting.com:5000/v1/exchanges",
              "method": "GET",
              "headers": {
        ...
        var settings = {
              "async": false,
              "crossDomain": true,
              "url": "http://ded4533.inmotionhosting.com:5000/v1/arbPairs",
              "method": "GET",
              "headers": {
                "Content-Type": "application/json",
                "Authorization": "Bearer "+accessToken
        ...
        var settings = {
              "async": false,
              "crossDomain": true,
              "url": "http://ded4533.inmotionhosting.com:5000/v1/arbFrequency",
              "method": "GET",
              "headers": {
                "Content-Type": "application/json",
                "Authorization": "Bearer "+accessToken
        ...
        $('#exchange1').on('change', function(){  
            ...
            var settings = {
                  "async": false,
                  "crossDomain": true,
                  "url": "http://ded4533.inmotionhosting.com:5000/v1/toggleExchange?exchId="+exchange,
                  "method": "GET",
                  "headers": {
                    "Content-Type": "application/json",
                    "Authorization": "Bearer "+accessToken
            ...
            var settings = {
                  "async": false,
                  "crossDomain": true,
                  "url": "http://ded4533.inmotionhosting.com:5000/v1/pairs?exchId="+exchange,
                  "method": "GET",
                  "headers": {
                    "Content-Type": "application/json",
                    "Authorization": "Bearer "+accessToken
        ...
        $('#pairs').on('change', function(){  
            ...
            var settings = {
                  "async": false,
                  "crossDomain": true,
                  "url": "http://ded4533.inmotionhosting.com:5000/v1/togglePair?exchId="+exchange+"&pair="+pair,
                  "method": "GET",
                  "headers": {
                    "Content-Type": "application/json",
                    "Authorization": "Bearer "+accessToken
            ...
            if(exchtoggle != toggle){
                var data ={exchId:exchange,toggle:toggle};
                    var settings = {
                      "async": false,
                      "crossDomain": true,
                      "url": "http://ded4533.inmotionhosting.com:5000/v1/toggleExchange",
                      "method": "POST",
                      "headers": {
                        "Content-Type": "application/json",
                        "Authorization": "Bearer "+accessToken
            ...
            if(pairtoggle != toggle){
                ...
                var data ={exchId:exchange,pair:pair,toggle:toggle};
                    var settings = {
                      "async": false,
                      "crossDomain": true,
                      "url": "http://ded4533.inmotionhosting.com:5000/v1/togglePair",
                      "method": "POST",
                      "headers": {
                        "Content-Type": "application/json",
                        "Authorization": "Bearer "+accessToken
        ...
        $('#pairs2').on('change', function(){  
            ...
            var settings = {
                  "async": false,
                  "crossDomain": true,
                  "url": "http://ded4533.inmotionhosting.com:5000/v1/arbCooldown?pair="+pair,
                  "method": "GET",
                  "headers": {
                    "Content-Type": "application/json",
                    "Authorization": "Bearer "+accessToken
        ...
        $('#cooldown').change(function() {
            ...
            var data ={pair:pair, cooldown:cooldown};
                var settings = {
                      "async": false,
                      "crossDomain": true,
                      "url": "http://ded4533.inmotionhosting.com:5000/v1/arbCooldown",
                      "method": "POST",
                      "headers": {
                        "Content-Type": "application/json",
                        "Authorization": "Bearer "+accessToken
        ...
        $('#exchange2').on('change', function(){  
            ...
            var settings = {
                  "async": false,
                  "crossDomain": true,
                  "url": "http://ded4533.inmotionhosting.com:5000/v1/toggleFee?exchId="+exchange,
                  "method": "GET",
                  "headers": {
                    "Content-Type": "application/json",
                    "Authorization": "Bearer "+accessToken
            ...
            if(feetoggle != toggle){
                var data ={exchId:exchange,toggle:toggle};
                    var settings = {
                      "async": false,
                      "crossDomain": true,
                      "url": "http://ded4533.inmotionhosting.com:5000/v1/toggleFee",
                      "method": "POST",
                      "headers": {
                        "Content-Type": "application/json",
                        "Authorization": "Bearer "+accessToken
