...
$lang['updates_subheader']					= "You can update Evoai network and the CodeIgniter framework upon which it is built. Below is the current status of your installation.";
...
$lang['updates_update_not_available']		= "You installation of Evoai network is up to date.";
$lang['updates_ob_install_text']			= "Your Evoai network Installation";
$lang['updates_ob_current_stable_text']		= "Current Stable Release";
$lang['updates_install_up_to_date_text']	= "Your Evoai network installation is up to date.  You don't need to do anything.";
$lang['updates_update_now_btn']				= "Update Now";
$lang['updates_update_success_resp']		= "Update Succeeded. Make sure to check your settings";
$lang['updates_update_failed_resp']			= "Unable to update Evoai network.  Please try again or find help on the Evoai network website.";
...
$lang['themes_subheader']					= 'Below is a list of currently installed themes.  To find more themes and installation instructions, visit us at the <a href="http://open-blog.org" target="_blank">Evoai network website</a>.';
