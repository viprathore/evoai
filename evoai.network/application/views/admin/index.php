        ...
        <?php if ($news): ?>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?= $item->excerpt ?> <br><span class="pull-right"><a href="http://open-blog.org" target="_blank">Visit the Evoai network Website for more Help and News.</a></span>
                </div>
            </div>
            <?php endforeach ?>
