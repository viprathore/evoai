 ...
 */
$config['site_title']                 = "evoai.network";       // Site Title, example.com
$config['admin_email']                = "info@evoai.network"; // Admin Email, admin@example.com
...
$config['otp']['issuer'] 				= "Evoai network"; 	// A provider/issuer shown as a title on OTP mobile apps
